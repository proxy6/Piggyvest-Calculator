...
calcButton.addEventListener("click", function(){
    ...
    //calculate for daily savings
      ...
      document.querySelector(".result").textContent = Math.round(dailyInterest);
    }
    ...
    // calculate for weekly 
        ...
        document.querySelector(".result").textContent = Math.round(weeklyInterest);
    ...
    //calculate for monthly
            ...
            for(var i=0; i<months.length; i++){
                if(months[i].id === calcMonth){
                    ...
                    document.querySelector(".result").textContent = Math.round(monthlyInterest);
                }
